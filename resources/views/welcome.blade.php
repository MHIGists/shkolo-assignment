...
<div
    ...
    <div class="p-4 rounded-md shadow-lg max-w-xl mx-auto text-gray-600 ">
        <p class="text-xl font-semibold mb-2">
            This is my own interpretation of the given task.
        </p>
        <p class="mb-2">
            I kept the default login system & profile settings as well as most of the style.
        </p>
        <p class="mb-2">
            Button settings can be found in the
            <span class="font-medium italic">User Dropdown</span>
            ->
            <span class="font-medium italic">Button settings</span>.
        </p>
        <p>
